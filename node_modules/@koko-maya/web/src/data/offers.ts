...
export const offers: Offer[] = [
    ...
    },
    {
        ...
        description: 'Loyalty deserves to be rewarded. Sign up as a member of Koko Maya Resort and unlock an additional 5% discount on all your bookings. It’s our way of saying thank you for choosing us as your home in Morjim. Member discounts are applied automatically when you log in or use your member unique code.',
        badge: 'Members',
        promoCode: 'MEMBER5',
        validUntil: null,
    ...
    },
    {
        ...
        description: 'Great vacations are fueled by great food. During your stay at Koko Maya Resort, enjoy a 10% discount on all your orders at our multi-cuisine restaurant, "Curry, Wok & Waves". From traditional Goan fish curry to vibrant Chinese stir-frys, savour the flavours of the coast for less.',
        badge: 'Dining',
        promoCode: null,
        validUntil: null,
